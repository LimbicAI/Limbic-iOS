// Generated by Apple Swift version 4.2 effective-4.1.50 (swiftlang-1000.0.29.2 clang-1000.10.39)
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Limbic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC6Limbic6Limbic")
@interface Limbic : NSObject
...
- (void)getStressForCurrentUserWithStartDate:(NSDate * _Nonnull)startDate endDate:(NSDate * _Nullable)endDate data:(NSDictionary<NSString *, id> * _Nullable)data completionHandler:(void (^ _Nonnull)(NSDictionary<NSDate *, NSDictionary<NSString *, NSNumber *> *> * _Nullable, NSError * _Nullable))completionHandler;
